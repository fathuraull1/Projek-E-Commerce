...
class Admin extends CI_Controller
{
	...
	function home()
	{
		if (!empty($this->session->userdata())) {
			...
			$data['title'] = 'Admin - Antihama Store';
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - Antihama Store';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - Antihama Store';
	...
	function edit_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - toko_antihama';
	...
	function produk()
	{
		$data['title'] = 'Produk - Antihama Store';
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - Toko Antihama';
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function edit_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit - Antihama Store';
			$data['supp'] = $this->model_app->view_ordering('tb_toko_supplier', 'id_supplier', 'DESC');
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function rekening()
	{
		...
		$data['title'] = 'Rekening - Antihama Store';
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - Toko Antihama';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - Antihama Store';
	...
	function supplier()
	{
		...
		$data['title'] = 'Supplier - Antihama Store';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - Antihama Store';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - Antihama Store';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - Antihama Store';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - Antihama Store';
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - Antihama Store';
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - Antihama Store';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - Antihama Store';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - Antihama Store';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - Antihama Store';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - Antihama Store';
	...
	function slider()
	{
		...
		$data['title'] = 'Slider - Antihama Store';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - Antihama Store';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - Antihama Store';
	...
	function halaman()
	{
		...
		$data['title'] = 'Halaman - Antihama Store';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - Antihama Store';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - Antihama Store';
	...
	function artikel()
	{
		$data['title'] = 'Artikel - Antihama Store';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - Antihama Store';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - Antihama Store';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - Antihama Store';
	...
	function edit_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Tag - Antihama Store';
	...
	function edit_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna - Antihama Store';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna - Antihama Store';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna - Antihama Store';
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - Antihama Store';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter - Antihama Store';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$ci->email->from('demo-ecommerce@zamanet.com', "Antihama Store");
			...
			$data['title'] = 'Kirim News Letter - Antihama Store';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita - Antihama Store';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - Antihama Store';
